...
const Only_Report = () => {
  ...
  async function handleSubmit(e) {
    e.preventDefault();
    try {
      const dataToSend = extractDataUpToKey(
        inspectionData,
        "rearSubFrameImages"
      );
      const response = await axios.post(
        "https://autofinder-backend.vercel.app/api/bodyFrameAccident/create",
        dataToSend
      );
  ...
  async function handleEngineSubmit(e) {
    ...
    try {
      ...
      const response = await axios.post(
        "https://autofinder-backend.vercel.app/api/engine/create",
        dataToSend
      );
      // console.log(response.data.data);
      alert(" Data Submited ");
  ...
  async function handleBrakeSubmit(e) {
    ...
    try {
      ...
      const response = await axios.post(
        "https://autofinder-backend.vercel.app/api/brakes/create",
        dataToSend
      );
      console.log(response.data.data);
      alert(" Data Submited ");
  ...
  async function handleSuspensionSubmit(e) {
    ...
    try {
      ...
      const response = await axios.post(
        "https://autofinder-backend.vercel.app/api/suspension/create",
        dataToSend
      );
      // console.log(response.data.data._id);
      alert(" Data Submited ");
  ...
  async function handleInteriorSubmit(e) {
    ...
    try {
      ...
      const response = await axios.post(
        "https://autofinder-backend.vercel.app/api/interior/create",
        dataToSend
      );
      // console.log(response.data.data);
      alert(" Data Submited ");
  ...
  async function handleAcHeaterSubmit(e) {
    ...
    try {
      ...
      const response = await axios.post(
        "https://autofinder-backend.vercel.app/api/acheater/create",
        dataToSend
      );
      // console.log(response.data.data);
      alert(" Data Submited ");
  ...
  async function handleElectronicsSubmit(e) {
    ...
    try {
      ...
      const response = await axios.post(
        "https://autofinder-backend.vercel.app/api/electronics/create",
        dataToSend
      );
      // console.log(response.data.data);
      alert(" Data Submited ");
  ...
  async function handleExteriorBodySubmit(e) {
    ...
    try {
      ...
      const response = await axios.post(
        "https://autofinder-backend.vercel.app/api/exteriorBody/create",
        dataToSend
      );
      // console.log(response.data.data._id);
      alert(" Data Submited ");
  ...
  async function handleTyresSubmit(e) {
    ...
    try {
      ...
      const response = await axios.post(
        "https://autofinder-backend.vercel.app/api/tyres/create",
        dataToSend
      );
      // console.log(response.data.data);
      alert(" Data Submited ");
  ...
  async function handleTestDriveSubmit(e) {
    ...
    try {
      ...
      const response = await axios.post(
        "https://autofinder-backend.vercel.app/api/testDrive/create",
        dataToSend
      );
      // console.log(response.data.data);
      alert(" Data Submited ");
  ...
  async function handleCarInspectionReport(e) {
    ...
    try {
      ...
      const response = await axios.post(
        "https://autofinder-backend.vercel.app/api/carInspectionReport/create",
        {
      ...
      alert(" Report Is Submited ");

      const res = await axios.get(
        `https://autofinder-backend.vercel.app/api/carInspectionReport/${response.data.data._id}`,
        {
          responseType: "blob",
        }
      );
  ...
  async function addCarInspectionReport() {
    try {
      const response = await axios.put(
        "https://autofinder-backend.vercel.app/api/carAd/insertReport",
        {
          carDetailsId: carDetailsId,
          carInspectionId: carInspectionReportId,
        }
      );
      alert(" Finall , Your Report Is Inspected ");
      console.log(response.data.data);
      setTimeout(() => {
        navigate("/Only_CarInspection_Home");
      }, 3000);
    } catch (error) {
  ...
  return (
    <div className="AdminDashboard">
      ...
      <div className="contentHolder">
        <p id="My_Car_ID_Pass">Car ID : {My_ID_Pass || "N/A"}</p>
        <p id="My_Car_ID_Pass">
          Car Details : {carDetail?.brand || "N/A"} {carDetail?.model || "N/A"}
          &nbsp; {carDetail?.year || "N/A"}
        </p>
        ...
        <form action="" onSubmit={handleSubmit} className="form">
          ...
          <div className="formgrid">
            <div>
              ...
              <select
                id="accident"
                name="radiatorCoreSupport"
                defaultValue="Non-Accidented"
        ...
        <form action="" onSubmit={handleInteriorSubmit}>
          ...
          <div className="formgrid">
            ...
            <div>
              ...
              <select
                id="accident"
                name="rightSeatAdjusterRecliner"
                defaultValue="Working"
                onChange={(e) => changeHandler(e)}
              >
                <option value="Not-Working">Not-Working</option>
            ...
            <div>
              ...
              <select
                id="accident"
                name="rightSeatAdjusterLearTrack"
                defaultValue="Working"
                onChange={(e) => changeHandler(e)}
              >
                <option value="Not-Working">Not-Working</option>
            ...
            <div>
              ...
              <select
                id="accident"
                name="leftSeatAdjusterLearTrack"
                defaultValue="Working"
                onChange={(e) => changeHandler(e)}
              >
                <option value="Not-Working">Not-Working</option>
            ...
            <div>
              ...
              <select
                id="interiorLightings"
                name="interiorLightings"
                defaultValue="Working"
                onChange={(e) => changeHandler(e)}
              >
                <option value="Not-Working">Not-Working</option>
            ...
            <div>
              <label htmlFor="trunkReleaseLeverButton">
                Trunk Release Lever Button
              </label>
              <select
                id="trunkReleaseLeverButton"
                name="trunkReleaseLeverButton"
                defaultValue="Working"
                onChange={(e) => changeHandler(e)}
              >
                <option value="Not-Working">Not-Working</option>
            ...
            <div>
              <label htmlFor="fuelCapReleaseLeverButton">
                Fuel Cap Release Lever Button
              </label>
              <select
                id="fuelCapReleaseLeverButton"
                name="fuelCapReleaseLeverButton"
                defaultValue="Working"
                onChange={(e) => changeHandler(e)}
              >
                <option value="Not-Working">Not-Working</option>
            ...
            <div>
              <label htmlFor="bonnetReleaseLeverButton">
                Bonnet Release Lever Button
              </label>
              <select
                id="bonnetReleaseLeverButton"
                name="bonnetReleaseLeverButton"
                defaultValue="Working"
                onChange={(e) => changeHandler(e)}
              >
                <option value="Not-Working">Not-Working</option>
            ...
            <div>
              <label htmlFor="frontRightSeatPoshish">
                Front Right Seat Poshish
              </label>
              <select
                id="frontRightSeatPoshish"
                name="frontRightSeatPoshish"
                defaultValue="Perfect"
                onChange={(e) => changeHandler(e)}
              >
                <option value="Damaged">Damaged</option>
            ...
            <div>
              <label htmlFor="frontLeftSeatPoshish">
                Front Left Seat Poshish
              </label>
              <select
                id="frontLeftSeatPoshish"
                name="frontLeftSeatPoshish"
                defaultValue="Perfect"
                onChange={(e) => changeHandler(e)}
              >
                <option value="Damaged">Damaged</option>
        ...
        <form action="" onSubmit={handleElectronicsSubmit}>
          ...
          <div className="formgrid">
            ...
            <div>
              <label htmlFor="oilPressureLowWarningLight">
                Oil Pressure Low Warning Light
              </label>
              <select
                id="oilPressureLowWarningLight"
            ...
            <div>
              <label htmlFor="temperatureWarningLight">
                Temperature Warning Light
              </label>
              <select
                id="temperatureWarningLight"
            ...
            <div>
              <label htmlFor="powerSteeringWarningLight">
                Power Steering Warning Light
              </label>
              <select
                id="powerSteeringWarningLight"
            ...
            <div>
              <label htmlFor="keyFobBatteryLowLight">
                Key Fob Battery Low Light
              </label>
              <select
                id="keyFobBatteryLowLight"
        ...
        <form action="" onSubmit={handleExteriorBodySubmit}>
          ...
          <div className="formgrid">
            ...
            <div>
              <label htmlFor="frontRightDoorWindow">
                Front Right Door Window
              </label>
              <select
                id="frontRightDoorWindow"
                name="frontRightDoorWindow"
                defaultValue="Ok"
                onChange={(e) => changeHandler(e)}
              >
                <option value="Ok">Ok</option>
            ...
            <div>
              <label htmlFor="frontLeftDoorWindow">
                Front Left Door Window
              </label>
              <select
                id="frontLeftDoorWindow"
                name="frontLeftDoorWindow"
                defaultValue="Ok"
                onChange={(e) => changeHandler(e)}
              >
                <option value="Ok">Ok</option>
            ...
            <div>
              <label htmlFor="rearRightDoorWindow">
                Rear Right Door Window
              </label>
              <select
                id="rearRightDoorWindow"
                name="rearRightDoorWindow"
                defaultValue="Ok"
                onChange={(e) => changeHandler(e)}
              >
                <option value="Ok">Ok</option>
            ...
            <div>
              ...
              <select
                id="rearLeftDoorWindow"
                name="rearLeftDoorWindow"
                defaultValue="Ok"
                onChange={(e) => changeHandler(e)}
              >
                <option value="Ok">Ok</option>
            ...
            <div>
              ...
              <select
                ...
                defaultValue="Cleaning Properly"
                onChange={(e) => changeHandler(e)}
              >
            ...
            <div>
              <label htmlFor="rightHeadlightWorking">
                Right Headlight (Working)
              </label>
              <select
                id="rightHeadlightWorking"
            ...
            <div>
              <label htmlFor="leftHeadlightWorking">
                Left Headlight (Working)
              </label>
              <select
                id="leftHeadlightWorking"
            ...
            <div>
              <label htmlFor="rightHeadlightCondition">
                Right Headlight (Condition)
              </label>
              <select
                id="rightHeadlightCondition"
            ...
            <div>
              <label htmlFor="leftHeadlightCondition">
                Left Headlight (Condition)
              </label>
              <select
                id="leftHeadlightCondition"
            ...
            <div>
              <label htmlFor="rightTaillightWorking">
                Right Taillight (Working)
              </label>
              <select
                id="rightTaillightWorking"
            ...
            <div>
              <label htmlFor="leftTaillightWorking">
                Left Taillight (Working)
              </label>
              <select
                id="leftTaillightWorking"
            ...
            <div>
              <label htmlFor="rightTaillightCondition">
                Right Taillight (Condition)
              </label>
              <select
                id="rightTaillightCondition"
            ...
            <div>
              <label htmlFor="leftTaillightCondition">
                Left Taillight (Condition)
              </label>
              <select
                id="leftTaillightCondition"
        ...
        <form action="" onSubmit={handleTyresSubmit}>
          ...
          <div className="formgrid">
            <div>
              <label htmlFor="rightHeadlightEurostar">
                Front Right Tyre Brand
              </label>
              <select
                id="rightHeadlightEurostar"
                name="frontRightTyreBrand"
                defaultValue="Eurostar"
                onChange={(e) => changeHandler(e)}
              >
        ...
        <form action="" onSubmit={handleTestDriveSubmit}>
          ...
          <div className="formgrid">
            ...
            <div>
              <label htmlFor="gearShiftingAutomatic">
            ...
            <div>
              <label htmlFor="steeringOperation">
            ...
            <div>
              <label htmlFor="steeringWheelAlignment">
        ...
        <button onClick={handleCarInspectionReport}>
          Add Inspection Report
        </button>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <button onClick={addCarInspectionReport}>
          Attach Report to Car Ad
        </button>
      </div>
    </div>
  );
